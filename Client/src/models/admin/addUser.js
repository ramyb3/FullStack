    ...
    <div style={{ textAlign: "center" }}>
      <div className="box">
        ...
        <input
          ...
          id="ID3"
          onClick={checkSubs}
          onChange={(e) => setUser({ ...user, CS: e.target.checked })}
        />{" "}
        ...
        <input
          ...
          id="ID4"
          onClick={checkSubs}
          onChange={(e) => setUser({ ...user, US: e.target.checked })}
        />{" "}
        ...
        <input
          ...
          id="ID5"
          onClick={checkSubs}
          onChange={(e) => setUser({ ...user, DS: e.target.checked })}
        />{" "}
        ...
        <input
          ...
          id="ID6"
          onClick={checkMovies}
          onChange={(e) => setUser({ ...user, CM: e.target.checked })}
        />{" "}
        Create Movies <br />
        <input
          type="checkbox"
          id="ID7"
          onClick={checkMovies}
          onChange={(e) => setUser({ ...user, UM: e.target.checked })}
        />{" "}
        Update Movies <br />
        <input
          type="checkbox"
          id="ID8"
          onClick={checkMovies}
          onChange={(e) => setUser({ ...user, DM: e.target.checked })}
        />{" "}
        Delete Movies <br />
        <br />
